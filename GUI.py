...
class GUI:
    ...
    def __init__(self):
        ...
        self.entry_generations_number = self.__new_entry()
        ...
        self.entry_elite_strategy_val = self.__new_entry()
        ...
        self.entry_immersion_operator_val = self.__new_entry()
